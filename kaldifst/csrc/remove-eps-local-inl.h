// kaldifst/csrc/remove-eps-local-inl.h
//
// This file is copied/modified from
// https://github.com/kaldi-asr/kaldi/blob/master/src/fstext/remove-eps-local-inl.h
...
#endif  // KALDIFST_CSRC_REMOVE_EPS_LOCAL_INL_H_
